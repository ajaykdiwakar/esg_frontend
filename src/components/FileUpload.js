...
class FileUpload extends React.Component {
  ...
  getNicList = () => {
    ...
    let url = `https://backend.esgds.com/companies/all_nic?access_token=` + token;
    fetch(url, {
      method: "GET"
    })
  ...
  handleControversyexcel = (e) => {
    ...
    if (!isNullOrUndefined(this.state.selectedControversyFiles)) {
      ...
      if (this.state.selectedControversyFiles && this.state.selectedControversyFiles.length > 0) {
        ...
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
        fetch("https://backend.esgds.com/controversies/upload?access_token=" + token, {
          method: "POST",
  ...
  getControversyjsondata = (arg) => {
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    let url = `https://backend.esgds.com/controversies/json/${arg.value}?access_token=` + token;
    fetch(url, {
      method: "GET"
    })
      .then((response) => response.json())
  ...
  handleChangeexcel = (e) => {
    ...
    if (!isNullOrUndefined(this.state.selectedFile)) {
      ...
      if (this.state.selectedFile && this.state.selectedFile.length > 0) {
        ...
        fetch("https://backend.esgds.com/standalone_datapoints/upload-company-esg?access_token=" + token, {
          method: "POST",
          body: data,
  ...
  getCompanyData(dropdowncompany) {
    ...
    //   const token= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    // let url ='https://backend.esgds.com/derived_datapoints/generate-json/'+dropdowncompany.value+'?access_token='+token;
    // fetch(url, {
    //   method: "GET"
    // })
    // .then((response) => response.json())
  ...
  //     const token= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
  //     let url ='https://backend.esgds.com/derived_datapoints/generate-json/'+companyname+'?access_token='+token;
  //     fetch(url, {
  //       method: "GET"
  //     })
  //     .then((response) => response.json())
  ...
  getCompanyCalculation = () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    let url = "https://backend.esgds.com/derived_datapoints/calculate/" + companyName + "?access_token=" + token;
    fetch(url, {
      method: "GET",
    })
      .then((response) => response.json())
  ...
  getPercentileCalculation = () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    let url = ' https://backend.esgds.com/polarity_rules/calculate_percentile/' + nic + '?access_token=' + token;
    fetch(url, {
      method: "GET",
    })
      .then((response) => response.json())
  ...
  getAllCompanyData = (arg) => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    let url = 'https://backend.esgds.com/derived_datapoints/generate-json/' + arg.value + '?access_token=' + token;
    fetch(url, {
      method: "GET"
    })
      .then((response) => response.json())
  ...
  getAllcompany = () => {
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYTI1MTBlMzU2ZDM2NjYwNWIwNDUzMyIsImlhdCI6MTYyMTY5MDQyMX0.52MKXMLD-A_QZxImaut5fpKFJ7MQQZB-so1ws5gVi0Q";
    fetch("https://backend.esgds.com/companies?access_token=" + token, {
      method: "GET"
    })
      .then((response) =>
        response.json())
